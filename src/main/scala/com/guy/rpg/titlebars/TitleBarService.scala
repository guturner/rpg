...
class TitleBarService {
  ...
  def buildTitleBar(title: String, titleBarHeight: Int, titleBarWidth: Int, borderWidth: Int): Array[Array[String]] = {
  ...
  def printTitleBar(titleBar: Array[Array[String]]): Unit = {
